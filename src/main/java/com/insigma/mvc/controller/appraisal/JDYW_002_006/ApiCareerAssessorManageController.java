package com.insigma.mvc.controller.appraisal.JDYW_002_006;
...
@RequestMapping("/api/careerAssessorManage")
public class ApiCareerAssessorManageController extends MvcHelper{
	
	@Resource
	private ApiCareerAssessorManageService careerAssessorManageService;
    ...
    @RequestMapping(value = "/getCareerAssessorList", method = RequestMethod.POST)
	public AjaxReturnMsg getCareerAssessorList(@ModelAttribute Hc73 hc73, BindingResult result ) throws Exception {
		if (result.hasErrors()) {
            return validate(result);
        }
		hc73.setAab001(hc73.getBaseinfoid());
		PageInfo<Hc73> pageinfo = careerAssessorManageService.getCareerAssessorList(hc73);
    ...
    public AjaxReturnMsg getCareerAssessorInfo(@ModelAttribute Hc73 hc73) throws Exception {
        return careerAssessorManageService.getCareerAssessorById(hc73.getChc073(), hc73.getAab001());
    }
    ...
    public AjaxReturnMsg getCareerAssessorInfoGBK(@ModelAttribute Hc73 hc73) throws Exception {
        return careerAssessorManageService.getCareerAssessorGBKById(hc73.getChc073(), hc73.getAab001());
    }
    ...
    public AjaxReturnMsg getIdcardInfo(@ModelAttribute Hc73 hc73) throws Exception {
        return careerAssessorManageService.getIdcardInfo(hc73.getAac002());
    }
    ...
    public AjaxReturnMsg checkAac002(@ModelAttribute Hc73 hc73) throws Exception {
    	return careerAssessorManageService.checkAac002(hc73);
    }
    ...
    public AjaxReturnMsg saveData(@ModelAttribute @Valid Hc73 hc73, BindingResult result) throws Exception {
        ...
        return careerAssessorManageService.saveData(hc73);
    }
    ...
    @RequestMapping(value = "/deleteCareerAssessor", method = RequestMethod.POST)
    public AjaxReturnMsg deleteCareerAssessor(@ModelAttribute @Valid Hc73 hc73, BindingResult result) throws Exception {
    	//检验输入
        if (result.hasErrors()) {
            return validate(result);
        }
    	return careerAssessorManageService.deleteCareerAssessor(hc73);
    }
    ...
    public AjaxReturnMsg batDelete(@ModelAttribute @Valid Hc73 hc73, BindingResult result) throws Exception {
    	...
    	return careerAssessorManageService.batDelete(hc73);
    }
    ...
    public AjaxReturnMsg checkQualification(@ModelAttribute Hc74 hc74) throws Exception {
    	return careerAssessorManageService.checkQualification(hc74);
    }
	...
	public AjaxReturnMsg getQualificationList(@ModelAttribute Hc74 hc74 ) throws Exception {
		PageInfo<Hc74> pageinfo = careerAssessorManageService.getQualificationList(hc74);
		return this.success(pageinfo);
    ...
    public AjaxReturnMsg saveQualification(@ModelAttribute @Valid Hc74 hc74, BindingResult result) throws Exception {
        ...
        return careerAssessorManageService.saveQualification(hc74);
    }
    ...
    public AjaxReturnMsg getQualification(@ModelAttribute Hc74 hc74) throws Exception {
        return careerAssessorManageService.getQualification(hc74.getChc074());
    }
    ...
    public AjaxReturnMsg deleteQualification(@ModelAttribute @Valid Hc74 hc74, BindingResult result) throws Exception {
        ...
        return careerAssessorManageService.deleteQualification(hc74.getChc074());
    }
	...
	public AjaxReturnMsg uploadFile(String file_bus_id, String file_name,String userid,
		...
		return careerAssessorManageService.uploadLogo(userid, file_bus_id, file_name, multipartFile);
	}
	...
	public AjaxReturnMsg uploadImage(String file_bus_id, String file_name,String userid,
									@RequestParam("uploadFile") MultipartFile multipartFile) {
		return careerAssessorManageService.uploadImage(userid, file_bus_id, file_name, multipartFile);
	}
    ...
    @RequestMapping(value = "/getCareerAssessorClasses", method = RequestMethod.POST)
	public AjaxReturnMsg getCareerAssessorClasses(@ModelAttribute Hc73 hc73, BindingResult result ) throws Exception {
		if (result.hasErrors()) {
            return validate(result);
        }
		hc73.setAab001(hc73.getBaseinfoid());
		PageInfo<Hb68> pageinfo = careerAssessorManageService.getCareerAssessorClasses(hc73);
		return this.success(pageinfo);
	}
}
