package com.insigma.mvc.controller.train.PXYW_001_007;
 ...
 */
@RestController
@RequestMapping("/api/companyUpload")
public class ApiCompanyUploadInfoController extends MvcHelper {

	@Resource
	private ApiCompanyUploadInfoService apiCompanyUploadInfoService;
    ...
    public AjaxReturnMsg getAd01FileById(Ad01File ad01File) throws Exception{
		return this.success(apiCompanyUploadInfoService.getInfoList(ad01File));
    }
    ...
    public AjaxReturnMsg getPhotoNum(Ad01File ad01File) throws Exception {
		return this.success(apiCompanyUploadInfoService.getFileNum(ad01File));	
	}
	...
	public AjaxReturnMsg uploadFile(String file_bus_id, String file_name,String userid,String desc,
		...
		return apiCompanyUploadInfoService.uploadImage(userid, file_bus_id, file_name,desc, multipartFile);
	}
    ...
    public AjaxReturnMsg uploadVideo(HttpServletRequest request,
        ...
        return apiCompanyUploadInfoService.uploadVideo(request, multipartFile);
    }
    ...
    public AjaxReturnMsg saveData(@ModelAttribute @Valid Ad01File ad01file, BindingResult result) throws Exception {
        ...
        return apiCompanyUploadInfoService.delete(ad01file);
    }
