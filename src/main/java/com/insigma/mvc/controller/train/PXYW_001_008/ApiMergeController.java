package com.insigma.mvc.controller.train.PXYW_001_008;
...
public class ApiMergeController extends MvcHelper {
	
	@Resource
	private ApiMergeService apiGraduationService;
	/**
	 * 初始化合并班期信息列表 
	 */
    ...
    public AjaxReturnMsg updateCHb528(@ModelAttribute @Valid Hb67 hb67, BindingResult result) throws Exception {
    	//检验输入
        if (result.hasErrors()) {
            return validate(result);
        }
