package com.insigma.mvc.dao.appraisal.JDYW_002_007;
...
public interface ApiInvigilatorManageMapper {
	List<Hc73> getInvigilatorList(Hc73 hc73 );

	Hc73 getInvigilatorById(@Param(value="chc073")String chc073, @Param(value="aab001")String aab001, @Param(value="aae100")String aae100, @Param(value="cac023")String cac023);

	List<Hc73> checkAac002(@Param(value="aac002")String aac002, @Param(value="aae100")String aae100);

	int addInvigilator(Hc73 hc73);

	int updateInvigilator(Hc73 hc73);

	int deleteInvigilator(String chb061);
	...
	Hc73 getInvigilatorGBKById(@Param(value="chc073")String chc073, @Param(value="aab001")String aab001, @Param(value="aae100")String aae100, @Param(value="cac023")String cac023);

	Hc73 getIdcardInfo(@Param(value="aac002")String aac002, @Param(value="aae100")String aae100);

	List<Hb68> getInvigilatorClasses(Hc73 hc73);
	...
	int deleteEmployment(@Param(value="chc073")String chc073, @Param(value="aab001")String aab00, @Param(value="aae100")String aae100, @Param(value="cac023")String cac023);
