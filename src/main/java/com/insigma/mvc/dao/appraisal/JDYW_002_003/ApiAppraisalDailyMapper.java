package com.insigma.mvc.dao.appraisal.JDYW_002_003;
...
public interface ApiAppraisalDailyMapper {
	
	List<Hb75Temp> getAppraisalDailyList(Hb75Temp hb75Temp);
	...
	List<Hb75Temp> getAppraisCoreList(@Param(value="hb75map")Map hb75map);

	List<CodeValue> getAca111List(@Param(value="id")String id, @Param(value="aca120")String aca120);

	List<CodeValue> getAca11aList(@Param(value="id")String id, @Param(value="aca111")String aca111);
}
