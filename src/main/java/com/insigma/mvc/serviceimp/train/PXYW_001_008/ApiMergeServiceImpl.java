package com.insigma.mvc.serviceimp.train.PXYW_001_008;
...
import com.insigma.mvc.dao.train.PXYW_001_008.ApiMergeMapper;
...
import com.insigma.mvc.service.train.PXYW_001_008.ApiMergeService;
/**
 * 班级结业管理
 * @author link
 * 2018-03-14
...
public class ApiMergeServiceImpl extends MvcHelper implements ApiMergeService {

	@Resource
	private ApiMergeMapper apiMergeMapper;
	...
	public PageInfo<Hb67> getHb67List(Hb67 hb67) throws Exception {
		List<Hb67> list = apiMergeMapper.getHb67List(hb67);
	...
	public PageInfo<Hb68> getHb68List(Hb68 hb68) throws Exception {
		...
		List<Hb68> list = apiMergeMapper.getHb68List(hb68);
	...
	public Hb68 getHb68ByChb068(Hb68 hb68) throws Exception {
		...
		newHb68 = apiMergeMapper.getHb68ByChb068(newHb68);
		hb68.setChb068s(hb68.getChb068().split(","));
		newHb68.setChb106(apiMergeMapper.getChb106All(hb68).get(0).getChb106());
		return newHb68;
	}
	/**
	 * 根据合并班级内码查询合并班级信息
	...
	public Hb67 getHb67ById(String chb067) throws Exception {
		return apiMergeMapper.getHb67ById(chb067);
	}
	/**
	 * 查询合并班级中学员列表
	 */
	...
	public PageInfo<Hc60> mergeHGStuList(Hc60 hc60) throws Exception {
		...
		List<Hc60> list=apiMergeMapper.mergeHGStuList(hc60);
	...
	public void addMargeClass(Hb67 hb67) throws Exception {
		...
		hb67.setChb316("0");
		hb67.setChb188("1");
		int num = apiMergeMapper.addMargeClass(hb67);
		if(num>0){
			Hb68 hb68 = new Hb68();
			...
			for(int i=0;i<chb068s.length;i++) {
				...
				apiMergeMapper.addHb66(hb66);
				index++;
			}
			int num2 = apiMergeMapper.updateClass(hb68);
	...
	public void updateChb528(Hb67 hb67) throws Exception {
		...
		int num = apiMergeMapper.updateHb67Chb528(hb67);
		if(num>0) {
			List<Hb66> list = apiMergeMapper.getHb66ByChb067(hb67);
			String chb068s ="";
			...
			if(list.size() == chb068s.split(",").length) {
				...
				int num2 = apiMergeMapper.updateHb68Chb528(hb68);
				if(num2>0) {
					return;
				}else {
