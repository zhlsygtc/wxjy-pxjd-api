package com.insigma.mvc.serviceimp.train.PXYW_001_007;
...
import com.insigma.mvc.dao.train.PXYW_001_007.ApiCompanyUploadInfoMapper;
...
import com.insigma.mvc.service.train.PXYW_001_007.ApiCompanyUploadInfoService;
/**
 * 机构风采管理
 * @author link
 * 2018-03-01
 */
@Service
public class ApiCompanyUploadInfoServiceImpl extends MvcHelper implements ApiCompanyUploadInfoService {

	private  static String localdir = AppConfig.getProperties("localdir");

	@Resource
	private ApiCompanyUploadInfoMapper apiCompanyUploadInfoMapper;
	@Resource
	...
	public PageInfo<Ad01File> getInfoList(Ad01File ad01File) throws Exception {
		...
		List<Ad01File> list=apiCompanyUploadInfoMapper.getInfoList(ad01File);
	...
	public AjaxReturnMsg uploadImage(String userid, String file_bus_id, String file_name, String desc, MultipartFile multipartFile) {
		try {
			...
			apiCompanyUploadInfoMapper.addAd01File(ad01File);
	...
	public AjaxReturnMsg delete(Ad01File ad01file) throws Exception{
		int num=0;
		num = apiCompanyUploadInfoMapper.delAd01File(ad01file);
		if(num == 1) {
	...
	public Ad01File getFileNum(Ad01File ad01file) {
		try {
			Ad01File ad01file2 = apiCompanyUploadInfoMapper.getPhotoNum(ad01file);
			ad01file2.setVideoNum(apiCompanyUploadInfoMapper.getVideoNum(ad01file).getVideoNum());
			ad01file2.setMaxPhoto(apiCompanyUploadInfoMapper.getMaxPhoto(ad01file).getMaxPhoto());
			ad01file2.setMaxVideo(apiCompanyUploadInfoMapper.getMaxVideo(ad01file).getMaxVideo());
			return ad01file2;
		} catch (Exception e) {
